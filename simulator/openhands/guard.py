...
SYSTEM = (
    ...
    "send 的 state_consistent=false 只记录分类 warning；只有 decision=reject 才阻止公开发送。"
    "transition 的同类差异也只保留私有 warning。"
...
class MessageGuard:
    ...
    def review(
        ...
        body = dict(
            ...
            stream=False,
            temperature=0,
            max_tokens=self.relay.config.get("max_output_tokens"),
